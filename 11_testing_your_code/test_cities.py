...
class TestCitiesFunction(unittest.TestCase):
    ...
    def test_city_country(self):
        ...
        correctly."""
        formatted_location_name = city_country(
    ...
    def test_city_country_population(self):
        ...
        correctly."""
        formatted_location_data = city_country(
            city="sheffield", country="united kingdom", population=240050
        )
        self.assertAlmostEqual(
            formatted_location_data, "Sheffield, United Kingdom - Population 240050"
        )
